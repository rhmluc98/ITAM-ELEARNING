        ...
        <div class="panel panel-success">
            <div class="panel-heading">
             ...
             <?php 
               ...
               if(isset($_GET['modifier_img_btn']))
               {
                $image_id = $_GET['modif_image_id'];
                $get_image = "SELECT *FROM images WHERE id_img='$image_id'";
                $run_get = mysqli_query($con,$get_image);

                foreach($run_get as $row_img)
                {

             ?>
            <div class="panel-body">
                <form action="code.php" method="post" class="form-horizontal" enctype="multipart/form-data">
                    <input type="hidden" name="image_id" id="" value="<?php echo $row_img['id_img'] ?>" class="form-control" required>
                    ...
                    <label for="" class="col-md-3 control-label">Nom d'image</label>
                        <div class="col-md-6">
                            <select type="text" name="modif_nom_image" id="" class="form-control" required>
                                <option value="" disabled><?php echo $row_img['img_nom'] ?></option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <img src="img/admin_photos/<?php echo $row_img['img_fichier']?>" width="70" height="70" alt="" style="border-radius: 10px">
                        </div>
                    </div>
                    <?php 
