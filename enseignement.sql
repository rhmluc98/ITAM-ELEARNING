...
--
-- Hôte : 127.0.0.1
-- Généré le :  ven. 22 oct. 2021 à 23:17
...
(1, 'Balyamwabo Chihinda', 'eleve', '202120038', '1380869780', 'Permis', 'connecter', 7),
...
(1, 'Institut Nova Stella', 'Bukavu/Panzi/Av.Mbogo. No356, Sud-kivu/RDC', '0974685245', 'novastella.info@gmail.com', 'Discipline,Travail et patriotisme', 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Obcaecati possimus consequuntur, deserunt minima nam reiciendis maiores incidunt quia magnam a ratione quaerat, asperiores expedita, quibusdam autem blanditiis eaque praesentium. Repellat.    ', 'Landscape (12).jpg');
...
(7, 'Balyamwabo', 'Chihinda', 'Emanuel', 1, '202120038', 'Masculin', 'Mushununu1', 'Flowers (1).jpg', '2021-2022'),
...
(1, 'Baniere_accueil', 'Anime (9).jpg', '2021-2022'),
(2, 'Baniere_apropos', 'Apple (8).jpg', '2021-2022'),
(3, 'Baniere_cours', 'Anime (23).jpg', '2021-2022'),
(4, 'Baniere_contact', 'Anime (73).jpg', '2021-2022'),
(5, 'Baniere_connexion', 'hacker-wallpaper15.jpg', '2021-2022'),
(6, 'Cours_img', 'Anime (23).jpg', '2021-2022');
...
--
ALTER TABLE `comptes`
  MODIFY `id_compte` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `eleves`
  MODIFY `id_eleves` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `images`
  MODIFY `id_img` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `t_cours`
  MODIFY `id_cours` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
COMMIT;
